...
import de.antoniusstrauch.mpc.core.usecase.leader.AttributeEvents;
import de.antoniusstrauch.mpc.core.usecase.leader.MergeAttributeEvents;
import de.antoniusstrauch.mpc.core.usecase.leader.MergeBatches;
...
public class Beans {
  ...
  public RequestAttribution getRequestAttribution(ILeaderServer leader,
    ...
    return new RequestAttribution(leader, helperOne, helperTwo);
  }
